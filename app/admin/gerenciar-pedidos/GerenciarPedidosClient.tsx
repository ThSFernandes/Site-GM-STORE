...
interface GerenciarPedidosClientProps {
...
const GerenciarPedidosClient: React.FC<GerenciarPedidosClientProps> = ({orders}) => {
    ...
    const handleDispatch = useCallback((id: string)=> {
        axios.put("/api/order", {
            ...
            toast.success("Produto foi despachado");
            router.refresh();
        }).catch((err) => {
    ...
    const handleDeliver = useCallback((id: string)=> {
        axios.put('/api/order', {
            ...
            toast.success("Produto foi entregue");
            router.refresh();
        }).catch((err) => {
            toast.error('Oops! Algo deu errado.');
            console.log(err);
...
export default GerenciarPedidosClient;